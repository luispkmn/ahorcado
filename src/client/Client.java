...
public class Client extends javax.swing.JFrame {
    ...
    private void SendMessage(String msg) throws IOException {
        try {
            ...
            System.out.println("No se pudo mandar el mensaje al servidor:" + ioExeption.toString());
            exitClient("error");
        }
    }
    ...
    private String ReceiveMessage() throws IOException {
        try {
            ...
            System.out.println("No se pudo recibir el mensaje del servidor:" + ioExeption.toString());
            exitClient("error");
            return "ERROR";
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Puntaje: 0");

        jLabel4.setText("Descubriste la palabra? Escribela aqui!");
        ...
        jMenuItem2.setText("Salir del Ahorcado");
